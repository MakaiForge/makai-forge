...
**Local:** `tools/prefix/makai_time/makai_time.py:103`
**Antes:**
```python
cmd.extend(["--ro-bind", "/", "/"])
```
...
**Local:** `tools/prefix/makai_time/overrides/capture.py:45`
**Antes:**
```python
...
**Local:** `tools/prefix/makai_time/overrides/detect.py:38-59`
...
**Local:** `tools/prefix/makai_time/overrides/mount.py:11`
...
**Local:** `tools/prefix/makai_time/core/ldso.py:162`
...
**Local:** `tools/prefix/makai_time/makai_time.py:~510`
...
**Local:** `tools/prefix/makai_time/prefix_config.py`
...
```json
{
  ...
  "runtime": {
    "name": "steamrt4",
    "path": "/home/cas/Documentos/Makai-forge/tools/prefix/steamrt4_platform_xxx",
