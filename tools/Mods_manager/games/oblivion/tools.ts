...
export function getTools(): ExternalToolDef[] {
  return [
    { name: "TES4Edit", exeName: "TES4Edit.exe", searchPaths: ["."], downloadUrl: "https://github.com/TES5Edit/TES5Edit/releases/latest/download/xEdit.4.1.5f.7z", detector: { file: "TES4Edit.exe" } },
