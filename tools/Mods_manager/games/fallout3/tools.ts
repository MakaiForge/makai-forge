...
export function getTools(): ExternalToolDef[] {
  return [
    { name: "FO3Edit", exeName: "FO3Edit.exe", searchPaths: ["."], downloadUrl: "https://github.com/TES5Edit/TES5Edit/releases/latest/download/xEdit.4.1.5f.7z", innerFolder: "TES5Edit", detector: { file: "FO3Edit.exe" } },
