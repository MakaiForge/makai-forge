...
export function getSkyrimTools(): ExternalToolDef[] {
  return [
    ...
    { name: "Pandora Behavior Engine+", exeName: "Pandora Behaviour Engine+.exe", searchPaths: ["."], downloadUrl: "https://github.com/Monitor221hz/Pandora-Behaviour-Engine-Plus/releases/latest/download/Pandora_Behaviour_Engine_Plus_v4.3.1-beta.zip", detector: { file: "Pandora Behaviour Engine+.exe" } },
