...
#### ProtonForge API (app/_main/torrent-rpc/protonforge-api/)
...
#### Prefix Core (app/_main/container/makai_time/engine/python/prefix/)
...
#### Mod Manager (app/Catalogo/GameMod/)
...
#### ForgePipeline (app/_main/installer-api/ForgePipeline/)
...
#### ProtonForge API (NOVA - app/_main/installer-api/proton_recommended/)
...
#### CompactFlow (app/_main/installer-api/CompactFlow/)
...
#### Setup Proton Environment (app/_main/container/events/)
...
1. **app/_main/torrent-rpc/protonforge-api/** — usado por Mod Manager (ProtonForgeRPC)
2. **app/_main/installer-api/proton_recommended/python/** — usado por ForgePipeline e CompactFlow
