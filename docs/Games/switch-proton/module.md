...
#### 1.1 `app/_main/torrent-rpc/protonforge-api/api/handler.py`
...
#### 1.2 `app/_main/installer-api/proton_recommended/python/api/handler.py`
...
echo '{"id":1,"method":"delete_prefix","params":{"prefix_path":"/tmp/test-prefix"}}' | python3 app/_main/torrent-rpc/protonforge-api/server.py

# Testar get_prefix_saves
echo '{"id":1,"method":"get_prefix_saves","params":{"prefix_path":"/home/cas/Games/Prefix/skyrim","game_id":"skyrim"}}' | python3 app/_main/torrent-rpc/protonforge-api/server.py
```
...
#### 2.1 `app/Catalogo/GameMod/events/mod-switch-proton.ts`
...
**Ação**: Adicionar import em `app/Catalogo/GameMod/events/index.ts` (ou onde os eventos são registrados)
...
#### 3.1 `app/Catalogo/GameMod/ui/components/GameConfigPanel/GameConfigPanel.tsx`
...
#### 3.2 `app/Catalogo/GameMod/ui/ModManager.tsx`
...
#### 4.1 `app/_main/installer-api/proton_recommended/ui/proton-recommendation-modal.tsx`
...
| Arquivo | Ação | Fase |
|---------|------|------|
| `app/_main/torrent-rpc/protonforge-api/api/handler.py` | Adicionar delete_prefix, clean_prefix, get_prefix_saves, restore_saves | 1 |
| `app/_main/installer-api/proton_recommended/python/api/handler.py` | Idem (manter sincronizado) | 1 |
| `app/Catalogo/GameMod/events/mod-switch-proton.ts` | **NOVO** — handler IPC principal | 2 |
| `app/Catalogo/GameMod/events/index.ts` | Importar mod-switch-proton.ts | 2 |
...
| `app/Catalogo/GameMod/ui/components/GameConfigPanel/GameConfigPanel.tsx` | Adicionar seção "Trocar Proton" | 3 |
| `app/Catalogo/GameMod/ui/ModManager.tsx` | Passar callback `onSwitchProton` | 3 |
| `app/_main/installer-api/proton_recommended/ui/proton-recommendation-modal.tsx` | Adicionar modo "switch" | 4 |
