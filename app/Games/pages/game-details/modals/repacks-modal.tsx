...
export function RepacksModal({
  ...
  useEffect(() => {
    const fetchDownloadSources = async () => {
      const sources = (await storeService.values(
        "downloadSources"
      )) as DownloadSource[];
  ...
  useEffect(() => {
    const fetchLastCheckTimestamp = async () => {
      ...
      try {
        const timestamp = (await storeService.get(
      ...
      storeService
        ...
        .then((gameData) => {
          if (gameData) {
            ...
            return storeService.put(gameKey, updated, "games");
          }
              ...
              return (
                ...
                >
                  ...
                  <p className="repacks-modal__repack-title">
                    {repack.title}
                    {repack.recommended && (
                      <span className="repacks-modal__recommended-badge">
                        {t("recommended")}
                      </span>
                    )}
