...
from engine.container.capsule import GPUManifest, capture_gpu_libs
from engine.container.steps import StepResult
from engine.container.steps import (
    isolation, runtime, gpu, audio, display, etc as etc_step,
    ssl, fonts, devices, mounts, env as env_step, exec as exec_step,
)
from engine.intel import get_container_config, identify_proton
...
class Builder:
    ...
    def run_capsule(self, runtime_path: Path):
        ...
        container_overrides = {}
        if fork_id:
            from engine.intel import get_container_overrides
