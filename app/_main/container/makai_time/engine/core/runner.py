...
from engine.consts import RUNTIME_DIR, FileLock
from engine.core.command import build_command
from engine.core.environment import check_env, set_env
from engine.core.prefix import setup_pfx
from engine.log import log
from engine.resolver.proton import (
    detect_proton_from_prefix,
    resolve_proton_path,
    validate_proton,
)
from engine.resolver.runtime import ensure_runtime, get_runtime_path, resolve_runtime_version
from engine.util.lock import unix_flock
from engine.util.process import run_command
...
def run(
    ...
    if proton_path:
        try:
            from engine.intel.injector import inject_features
            from engine.container.manifest import save_game_session
