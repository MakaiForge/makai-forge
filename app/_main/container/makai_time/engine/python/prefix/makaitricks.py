...
Unified module at app/_main/container/makai_time/engine/python/prefix/makaitricks.py.

Re-exported by:
  - tools/python-rpc/protonforge-api/api/services/prefix/
  - app/_main/installer-api/proton_recommended/python/api/services/prefix/
"""
...
_INSTALL_API_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), *([".."] * 6), "app", "_resources", "binaries")
)
