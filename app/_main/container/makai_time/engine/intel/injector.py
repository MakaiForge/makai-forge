...
from engine.intel import identify_proton, PROTON_KNOWLEDGE
from engine.intel.anticheat import (
    detect_anticheat,
    get_ac_env_vars,
...
log = logging.getLogger("engine.intel.injector")
...
def _apply_profile(result: dict[str, Any], game_id: str | None, game_exe: str | None = None) -> None:
    ...
    try:
        from engine.intel.profiles import get_profile, find_by_exe
...
def _apply_audio_intelligence(
    ...
    """
    try:
        from engine.intel.audio import analyze_audio
