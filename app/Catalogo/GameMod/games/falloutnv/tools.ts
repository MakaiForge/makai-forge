...
export function getTools(): ExternalToolDef[] {
  return [
    { name: "FNVEdit", exeName: "xFOEdit64.exe", searchPaths: ["."], downloadUrl: "https://github.com/TES5Edit/TES5Edit/releases/latest/download/xEdit.4.1.5f.7z", detector: { file: "xFOEdit64.exe" } },
