...
export function getSkyrimTools(): ExternalToolDef[] {
  return [
    { name: "SSEEdit", exeName: "xTESEdit64.exe", searchPaths: ["."], downloadUrl: "https://github.com/TES5Edit/TES5Edit/releases/latest/download/xEdit.4.1.5f.7z", detector: { file: "xTESEdit64.exe" } },
    ...
    { name: "ESLifier", exeName: "ESLifier.exe", searchPaths: ["."], downloadUrl: "https://github.com/MaskPlague/ESLifier/releases/download/v0.15.3/ESLifier.zip", detector: { file: "ESLifier.exe" } },
    { name: "Pandora Behavior Engine+", exeName: "Pandora Behaviour Engine+.exe", searchPaths: ["."], downloadUrl: "https://github.com/Monitor221hz/Pandora-Behaviour-Engine-Plus/releases/latest/download/Pandora_Behaviour_Engine_v4.3.1-beta_win-x64_net.zip", detector: { file: "Pandora Behaviour Engine+.exe" } },
